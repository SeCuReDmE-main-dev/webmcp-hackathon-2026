...
export function ConsoleShell({ theme, onThemeChange, view, onViewChange, children, inspector, supported, toolCount, registrationStatus, sessionId, companionStatus, onOpenCompanion }: {
  ...
  children: ReactNode; inspector(navigate: (view: ConsoleView) => void): ReactNode; supported: boolean; toolCount: number; registrationStatus: string; sessionId: string; companionStatus: string; onOpenCompanion(): void
}) {
